...
const AboutSection = () => {
    ...
    const timelineInView = useInView(sectionRef, { once: true, margin: "-50px" });
                    ...
                    >
                            ...
                            <div className='grid gap-4'>
                                {PASSIONS.map((passion) => (
                                    <motion.div
                                        ...
                                        variants={itemVariants}
                                        whileHover={{ x: 4 }}
                                        className={`flex items-center space-x-4 p-4 rounded-full ${isDarkMode
                        ...
                        <motion.div variants={itemVariants} className='text-center py-8'>
                            ...
                            <div className='flex justify-center'>
                                <img src={SIGNATURE} alt="Subhash" className='w-28' />
                            </div>
                    ...
                    >
                        ...
                        <div className='space-y-8'>
                            {JOURNEY_STEPS.map((step) => (
                                ...
                                >
                                    {/* Timeline Dot  */}
                                    <div className={`relative z-10 flex flex-shrink-0 w-16 h-16 rounded-full ${step.color} items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                                    >
                                        <step.icon size={24} className='text-white' />
                                    </div>

                                    {/* Content  */}
                                    <div className={`flex-grow p-6 rounded-xl border transition-all duration-300 ${isDarkMode
                                        ? "bg-gray-800/50 border-gray-700 group-hover:border-gray-600 group-hover:bg-gray-800/70"
                                        : "bg-white/80 border-gray-200 group-hover:border-gray-600 group-hover:bg-white"
                                        } backdrop-blur-sm`}
                                    >
